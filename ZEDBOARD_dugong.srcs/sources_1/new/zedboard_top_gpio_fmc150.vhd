...
entity zedboard_top_gpio_fmc150 is
	generic(
		NUMBER_OF_MASTERS : NATURAL := 1;
		NUMBER_OF_SLAVES  : NATURAL := 8
	);
	port(
		...
		FMC150_CLK_P    : in    STD_LOGIC;
		FMC150_CLK_N    : in    STD_LOGIC;
...
end entity zedboard_top_gpio_fmc150;

architecture RTL of zedboard_top_gpio_fmc150 is
	--------------------------------
